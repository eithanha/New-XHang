class PipePair{
    ...
    constructor(topPipeImg, bottomPipeImg, gapHeight, topPipeHitImg, bottomPipeHitImg){
    ...
    draw() {        
        if (this.hit) {
            ...
            image(this.bottomPipeHitImg, this.x, height - this.bottomHeight, PipePair.WIDTH, this.bottomHeight);
        } else {
            image(this.topPipeImg, this.x, 0, PipePair.WIDTH, this.topHeight);
            image(this.bottomPipeImg, this.x, height - this.bottomHeight, PipePair.WIDTH, this.bottomHeight);
        }
    }
